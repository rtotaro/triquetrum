 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.triquetrum.commands.tqcl.impl.ParameterImpl#getName <em>Name</em>}</li>
...
public class ParameterImpl extends MinimalEObjectImpl.Container implements Parameter
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TqclPackage.PARAMETER__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TqclPackage.PARAMETER__NAME:
        return getName();
